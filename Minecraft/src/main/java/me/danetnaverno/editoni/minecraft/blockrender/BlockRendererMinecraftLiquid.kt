...
class BlockRendererMinecraftLiquid : BlockRenderer()
{
    ...
    override fun draw(world: World, location: BlockLocation): Boolean
    {
        ...
        if (shouldRenderSideAgainst(world, location.add(0, 1, 0)))
        {
            ...
            GL11.glVertex3f(x1, location.globalY + height, z1)
            GL11.glTexCoord2f(1.0f, 0.0f)
            GL11.glVertex3f(x1, location.globalY + height, location.globalZ + 1.0f)
            GL11.glTexCoord2f(1.0f, 1.0f)
            GL11.glVertex3f(location.globalX + 1.0f, location.globalY + height, location.globalZ + 1.0f)
            GL11.glTexCoord2f(0.0f, 1.0f)
            GL11.glVertex3f(location.globalX + 1.0f, location.globalY + height, z1)
            GL11.glEnd()
        }
        ...
        if (shouldRenderSideAgainst(world, location.add(0, -1, 0)))
        {
            ...
            GL11.glTexCoord2f(1.0f, 0.0f)
            GL11.glVertex3f(location.globalX + 1.0f, y1, z1)
            GL11.glTexCoord2f(1.0f, 1.0f)
            GL11.glVertex3f(location.globalX + 1.0f, y1, location.globalZ + 1.0f)
            GL11.glTexCoord2f(0.0f, 1.0f)
            GL11.glVertex3f(x1, y1, location.globalZ + 1.0f)
            GL11.glEnd()
        }
