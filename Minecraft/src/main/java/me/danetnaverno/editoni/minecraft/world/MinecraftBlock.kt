...
class MinecraftBlock(chunk: Chunk, pos: BlockLocation, blockType: BlockType, blockState: BlockState?, tileEntity: TileEntity?)
    : Block(chunk, pos, blockType, blockState, tileEntity)